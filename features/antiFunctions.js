...
export async function checkAntiSticker(sock, msg, from, sender, messageContent, type, isMe, isAdmin, isOwner, sendLog) {
...
export async function checkAntiMedia(sock, msg, from, sender, type, isMe, isAdmin, isOwner, sendLog) {
...
export async function checkAntiLink(sock, msg, from, sender, text, isMe, isAdmin, sendLog) {
...
export async function checkAntiStatus(sock, msg, from, sender, messageContent, isMe, isAdmin, isOwner, sendLog) {
