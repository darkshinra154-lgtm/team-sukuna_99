export default async function(sock, chatId, msg, isOwner, botData, saveBotData, args) {
    ...
    if (action === 'on') {
        ...
        saveBotData();
        await sock.sendMessage(chatId, { text: '\u{1F9EA} Anti-bug protection ON!' }, { quoted: msg });
    } else if (action === 'off') {
