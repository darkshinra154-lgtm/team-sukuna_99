...
// Helper to collect stream into buffer (downloadContentFromMessage returns a stream in baileys)
...
// ESM Exports
export default handleAntideleteCommand;
export { storeMessage, handleMessageRevocation, handleSnipe };