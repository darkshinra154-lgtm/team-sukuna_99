...
import { isTgOwner, getAllActiveSockets, getConnectedBotNumbers } from '../utils/helpers.js';
import BotSession from '../classes/BotSession.js';

let tgBot = null;

export function initializeTelegram(io) {
...
const botNumbers = getConnectedBotNumbers(state.sessions);
